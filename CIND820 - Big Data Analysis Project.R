...
counts <- table(googleApps$Genres)
barplot(counts,main="Genre Distribution", xlab="Genre")    ## Doesn't show all Genre levels
...
ggplot(googleApps, aes(x = `Content Rating`, fill = Rating)) + geom_bar(position = "dodge") 
